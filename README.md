...
- 只有用户明确点名 skill 名字时才启用
- AI 不允许因为“看起来适合”而自动套用
...
两个 skill 都会把 HTML 产物放到当前项目下的 `html/` 目录：
...
HTML 文件命名必须和当前问题切题，让人一眼就能看出主题，例如：
...
*** Add File: C:\Users\24858\Documents\Codex\2026-06-28\bug-1-2-3-4-5\work\sharewhy\skills\pre-code\SKILL.md
---
name: pre-code
